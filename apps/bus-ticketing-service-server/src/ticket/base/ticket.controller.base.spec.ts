  ...
  test("POST /tickets", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        journeyDate: CREATE_RESULT.journeyDate.toISOString(),
      ...
      .expect([
        {
          ...
          journeyDate: FIND_MANY_RESULT[0].journeyDate.toISOString(),
  ...
  test("GET /tickets/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        journeyDate: FIND_ONE_RESULT.journeyDate.toISOString(),
